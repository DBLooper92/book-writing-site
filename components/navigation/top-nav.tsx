...
const navLinks = [
  ...
  { href: "/plot-threads", label: "Plot Threads" },
  { href: "/outlines", label: "Outlines" },
  { href: "/glossary-terms", label: "Glossary Terms" },
  ...
  { href: "/timeline-events", label: "Timeline Events" },
  { href: "/timeline", label: "Timeline" },
  { href: "/notes", label: "Notes" },
  { href: "/retcons", label: "Retcons" },
  { href: "/attachments", label: "Attachments" },
  { href: "/ai-sessions", label: "AI Sessions" },
