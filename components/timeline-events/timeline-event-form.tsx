...
export function TimelineEventForm({
  ...
  function handleViewLinkedRecord(
    entityType: TimelineLinkedRecordType,
    linkedId: string,
    option?: TimelineReferenceOption
  ) {
    const href = buildLinkedRecordHref(entityType, linkedId);

    if (!href) {
      return;
    }

    setSelectedLinkedRecord({
      entityType,
      id: linkedId,
      label: option?.label ?? linkedId,
      href,
      missing: !option,
      meta: option?.meta,
    });
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            <MultiPickerField
              ...
              onView={(linkedId, option) => handleViewLinkedRecord("book", linkedId, option)}
            ...
            <MultiPickerField
              ...
              onView={(linkedId, option) =>
                handleViewLinkedRecord("chapter", linkedId, option)
              }
            ...
            <MultiPickerField
              ...
              onView={(linkedId, option) => handleViewLinkedRecord("scene", linkedId, option)}
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            <MultiPickerField
              ...
              onView={(linkedId, option) =>
                handleViewLinkedRecord("character", linkedId, option)
              }
              loading={formOptions.loading}
              onCreate={
                inlineCreationContext
            ...
            <MultiPickerField
              ...
              onView={(linkedId, option) =>
                handleViewLinkedRecord("location", linkedId, option)
              }
              loading={formOptions.loading}
              onCreate={
                inlineCreationContext
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-4 lg:grid-cols-2 xl:grid-cols-3">
            <MultiPickerField
              ...
              onView={(linkedId, option) => handleViewLinkedRecord("faction", linkedId, option)}
              loading={formOptions.loading}
              onCreate={
                inlineCreationContext
                  ? () =>
            ...
            <MultiPickerField
              ...
              onView={(linkedId, option) => handleViewLinkedRecord("culture", linkedId, option)}
              loading={formOptions.loading}
              onCreate={
                inlineCreationContext
                  ? () =>
            ...
            <MultiPickerField
              ...
              onView={(linkedId, option) =>
                handleViewLinkedRecord("religion", linkedId, option)
              }
              loading={formOptions.loading}
              onCreate={
                inlineCreationContext
            ...
            <MultiPickerField
              ...
              onView={(linkedId, option) =>
                handleViewLinkedRecord("technology", linkedId, option)
              }
              loading={formOptions.loading}
              onCreate={
                inlineCreationContext
            ...
            <MultiPickerField
              ...
              onView={(linkedId, option) =>
                handleViewLinkedRecord("plotThread", linkedId, option)
              }
              loading={formOptions.loading}
              onCreate={
                inlineCreationContext
            ...
            <MultiPickerField
              ...
              onView={(linkedId, option) => handleViewLinkedRecord("theme", linkedId, option)}
              loading={formOptions.loading}
              onCreate={
                inlineCreationContext
                  ? () =>
...
function MultiPickerField({
  ...
  onView?: (linkedId: string, option?: TimelineReferenceOption) => void;
  loading: boolean;
  hint?: string;
  onCreate?: () => void;
}) {
            ...
            return (
              ...
              >
                {onView ? (
                  <button
                    type="button"
                    onClick={() => onView(selectedValue, selectedOption)}
                    className="absolute -left-2 top-1/2 inline-flex h-6 w-6 -translate-y-1/2 items-center justify-center rounded-md border border-zinc-200 bg-white text-zinc-700 opacity-0 shadow-sm transition group-hover:opacity-100 group-focus-within:opacity-100 hover:bg-zinc-100"
                    aria-label={`View ${selectedOption?.label ?? selectedValue}`}
                ...
                <span className="inline-flex items-center rounded-full bg-white px-3 py-2 text-sm text-zinc-700 ring-1 ring-zinc-200">
                ...
                <button
                  ...
                  className="absolute -right-2 top-1/2 inline-flex h-6 w-6 -translate-y-1/2 items-center justify-center rounded-md border border-red-200 bg-red-50 text-red-700 opacity-0 shadow-sm transition group-hover:opacity-100 group-focus-within:opacity-100 hover:bg-red-100"
                  aria-label={`Remove ${selectedOption?.label ?? selectedValue}`}
...
function buildLinkedRecordHref(entityType: TimelineLinkedRecordType, linkedId: string) {
  switch (entityType) {
    case "book":
      return `/books/${linkedId}`;
    case "chapter":
      return `/chapters/${linkedId}`;
    case "scene":
      return `/scenes/${linkedId}`;
    case "character":
      return `/characters/${linkedId}`;
    case "location":
      return `/locations/${linkedId}`;
    case "era":
      return `/eras/${linkedId}`;
    case "faction":
      return `/factions/${linkedId}`;
    case "culture":
      return `/cultures/${linkedId}`;
    case "religion":
      return `/religions/${linkedId}`;
    case "technology":
      return `/technologies/${linkedId}`;
    case "plotThread":
      return `/plot-threads/${linkedId}`;
    case "theme":
      return `/themes/${linkedId}`;
    case "timelineEvent":
      return `/timeline-events/${linkedId}`;
    default:
      return "";
  }
}
