...
- the manuscript editor now keeps the same manuscript page model in standalone and embedded split-screen modes, scaling the full page down in narrow panes instead of changing line breaks or page counts
