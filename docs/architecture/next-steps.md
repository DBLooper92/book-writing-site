...
- watch the new manuscript editor and Draft split-screen/new-window workflow for ergonomics, sparse chapter expansion, scaled-page readability, and autosave behavior after author testing
