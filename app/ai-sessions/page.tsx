...
export default function AiSessionsPage() {
  ...
  return (
    <PageShell
      ...
      description="Browse, create, and manage tracked AI work inside the currently active story-bible project. All AI session documents are scoped to the active project under users/{uid}/projects/{projectId}/ai_sessions/{sessionId}."
    >
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-xs uppercase tracking-[0.18em] text-zinc-500">
              Scope: users/{`{uid}`}/projects/{activeProjectId ?? "{projectId}"}/ai_sessions
            </p>
          </div>
