...
export default function AiSessionDetailPage() {
  ...
  return (
    <PageShell
      ...
      description="AI session records are loaded from the active project's scoped ai_sessions rows so each detail view stays scoped to the current story bible."
    >
