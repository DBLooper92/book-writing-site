...
export default function CharacterDetailPage() {
  ...
  return (
    <PageShell
      ...
      description="Character records are loaded from the active project's nested characters collection so every detail view stays scoped to the current story bible."
    >
