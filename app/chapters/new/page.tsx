...
export default function NewChapterPage() {
  ...
  return (
    <PageShell
      ...
      description="Start a new chapter inside the currently active project. This initial form is intentionally small but it writes into the full project-scoped chapter record shape."
    >
