...
export default function NewThemePage() {
  ...
  return (
    <PageShell
      eyebrow="Themes"
      title="Create theme"
      description="Start a new theme inside the currently active project. This initial form is intentionally small but it writes into the full project-scoped theme record shape."
    >
