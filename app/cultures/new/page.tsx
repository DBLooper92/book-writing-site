...
export default function NewCulturePage() {
  ...
  return (
    <PageShell
      ...
      description="Start a new culture inside the currently active project. This initial form is intentionally small but it writes into the full project-scoped culture document shape."
    >
