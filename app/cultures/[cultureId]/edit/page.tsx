...
import { updateCultureForProject } from "@/lib/firebase/cultures";
import {
  cultureToFormValues,
...
export default function EditCulturePage() {
  ...
  return (
    <PageShell
      ...
      description="Update the first set of structured culture fields and write the changes back to the currently active project's nested culture document."
    >
