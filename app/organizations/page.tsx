...
export default function OrganizationsPage() {
  const { organizations, loading, error, user, activeProjectId, activeProject } =
    useOrganizations();
    ...
    >
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-600">
              {activeProject
                ? `Viewing organizations for ${activeProject.title} (${activeProject.id}).`
      ...
      {!user ? (
        <StateCard tone="warning">
          Sign in first to view organizations for your projects.{" "}
        ...
        <StateCard tone="neutral">
          Loading organization records for the active project...
        </StateCard>
        ...
        <StateCard tone="neutral">
          No organizations exist in {activeProject.title} yet.{" "}
