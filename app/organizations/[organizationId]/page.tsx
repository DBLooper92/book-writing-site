...
export default function OrganizationDetailPage() {
  ...
  return (
    <PageShell
      ...
      description="Organization records are loaded from the active project's scoped organizations rows so institutional references stay scoped to the current story bible."
    >
