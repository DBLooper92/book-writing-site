...
export default function EditOrganizationPage() {
  ...
  return (
    <PageShell
      ...
      description="Update the first set of structured organization fields and write the changes back to the currently active project's scoped organization row."
    >
