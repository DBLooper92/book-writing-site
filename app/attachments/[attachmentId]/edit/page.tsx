...
export default function EditAttachmentPage() {
  ...
  return (
    <PageShell
      ...
      description="Update the first set of structured attachment metadata fields and write the changes back to the currently active project's nested attachment document."
    >
