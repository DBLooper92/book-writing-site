...
export default function LanguageDetailPage() {
  ...
  return (
    <PageShell
      ...
      description="Language records are loaded from the active project's nested languages collection so linguistic references stay scoped to the current story bible."
    >
