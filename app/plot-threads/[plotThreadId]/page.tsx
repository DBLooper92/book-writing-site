...
export default function PlotThreadDetailPage() {
  ...
  return (
    <PageShell
      ...
      description="Plot-thread records are loaded from the active project's nested plot_threads collection so narrative-thread references stay scoped to the current story bible."
    >
