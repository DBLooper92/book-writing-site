...
import { deleteTimelineEventForProject } from "@/lib/data/timeline-events";
...
export default function TimelineEventDetailPage() {
  ...
  async function handleDeleteTimelineEvent() {
    if (!timelineEvent || !uid || !activeProjectId || deleting) {
      return;
    }
    ...
    try {
      ...
      const message =
        nextError instanceof Error ? nextError.message : "Unable to delete this timeline event.";
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {timelineEvent ? (
              <>
                ...
                >
                  {deleting ? "Deleting..." : "Delete timeline event"}
                </button>
              </>
            ) : null}
          </div>
