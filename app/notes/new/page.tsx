...
import { createNoteForProject } from "@/lib/firebase/notes";
...
export default function NewNotePage() {
  ...
  async function handleCreateNote(values: NormalizedNoteFormValues) {
    if (!uid || !activeProjectId) {
      throw new Error("Select an active project before creating a note.");
    }

    const noteId = await createNoteForProject(uid, activeProjectId, values);
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-600">
              {activeProject
                ...
                : "A project must be active before note creation can continue."}
            </p>
          </div>
