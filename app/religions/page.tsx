...
export default function ReligionsPage() {
  ...
  return (
    <PageShell
      ...
      description="Browse, create, and manage religion records inside the currently active story-bible project. All religion documents are scoped to the active project under users/{uid}/projects/{projectId}/religions/{religionId}."
    >
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-xs uppercase tracking-[0.18em] text-zinc-500">
              Scope: users/{`{uid}`}/projects/{activeProjectId ?? "{projectId}"}/religions
            </p>
          </div>
