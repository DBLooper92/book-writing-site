...
export default function ReligionDetailPage() {
  ...
  return (
    <PageShell
      ...
      description="Religion records are loaded from the active project's scoped religions rows so belief-system references stay scoped to the current story bible."
    >
