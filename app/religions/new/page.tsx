...
export default function NewReligionPage() {
  ...
  return (
    <PageShell
      ...
      description="Start a new religion inside the currently active project. This initial form is intentionally small but it writes into the full project-scoped religion document shape."
    >
