...
export default function NewGlossaryTermPage() {
  ...
  return (
    <PageShell
      ...
      description="Start a new glossary term inside the currently active project. This first-pass form stays small, but it writes into the full project-scoped glossary record shape."
    >
